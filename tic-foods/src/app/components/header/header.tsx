...
const Header = () => {
  ...
  return (
    <>
      {/* Header */}
      <header
        className="bg-gradient-to-r text-orange shadow-md sticky top-0 z-50"
          ...
          <div className="bg-gradient-to-r text-black shadow-md sticky top-0 z-50">
            <nav className="p-4 space-y-4 text-lg font-serif">
              ...
              <div className="flex space-x-4 pt-2">
                <Link
                  href=""
                  className="block text-orange hover:text-orange-600"
                >
                ...
                <div className="relative">
                  <button
                    onClick={toggleLanguageMenu}
                    className="flex items-center space-x-2 text-orange hover:text-orange-600"
                  >
