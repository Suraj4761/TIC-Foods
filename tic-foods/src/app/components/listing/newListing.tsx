...
import {FoodData} from '../../helpers/dummy'

const FoodItems = () => {
   const handleToast = (name: any) => toast.success(` added ${name} to cart`);
      ...
      <>
         ...
         <div className="py-5">
            ...
            <div className="flex flex-wrap justify-center gap-10 lg:mx-20">
               {FoodData.map((food: { id: any; name: any; price: any; desc: any; rating: any; img: any; }) => {
                  return (
                     <FoodCard
                        key={food.id}
                        id={food.id}
